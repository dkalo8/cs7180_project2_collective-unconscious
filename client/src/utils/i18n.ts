...
export const T: any = {
  zh: {
    ...
    create: {
      ...
      participantLimit: "人数上限", unlimited: "不限", roundLimit: "轮数上限",
      timeout: "超时设置",
  ...
  en: {
    ...
    create: {
      ...
      participantLimit: "Participant limit", unlimited: "Unlimited", roundLimit: "Round limit",
  ...
  es: {
    ...
    create: {
      ...
      participantLimit: "Límite de participantes", unlimited: "Sin límite", roundLimit: "Límite de rondas",
