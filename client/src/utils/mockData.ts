...
export const LOGS: any[] = [
  ...
  },
  {
    ...
    participants: [{ name: "透明野猪神", color: COLORS[3] },{ name: "暴力赛博男", color: COLORS[4] },{ name: "东京十字架", color: COLORS[5] }],
    turns: [
  ...
  },
  {
    ...
    participants: [{ name: "午夜悲情子", color: COLORS[4] },{ name: "虚构血管女", color: COLORS[1] }],
    turns: [
  ...
  },
  {
    ...
    participants: [{ name: "魔法飞行兽", color: COLORS[2] },{ name: "死亡碳基体", color: COLORS[0] },{ name: "无聊病娇酱", color: COLORS[5] }],
    turns: [
